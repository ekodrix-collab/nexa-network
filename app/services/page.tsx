...
const services = [
  { id: 'network', icon: Network, title: 'Network Infrastructure & Passive Infrastructure', subtitle: 'Passive & Active Networks', description: 'Design and implement reliable, scalable, and secure network infrastructure that ensures seamless connectivity and efficient business operations across your organization.', features: ['Structured Cabling (Cat6/Cat6a/Fiber)', 'LAN/WAN Design & Implementation', 'Enterprise WiFi Solutions', 'Network Monitoring & Management', 'Switch & Router Configuration', 'Network Security Appliances'], accent: '#3B82F6' },
          ...
          {services.map((service, i) => {
            ...
            return (
              <ScrollReveal key={service.title} delay={0.1}>
                <div id={service.id} className="bg-white dark:bg-[#0d1c22]/60 backdrop-blur-md rounded-3xl p-8 lg:p-10 border border-black/5 dark:border-white/10 hover:border-black/10 dark:hover:border-white/15 shadow-sm dark:shadow-none hover:shadow-lg dark:hover:shadow-none transition-all duration-300 scroll-mt-24">
