    ...
    <div className="pt-20">
      ...
      <section className="py-24 bg-[#0a1518]">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
            ...
            {resourceCards.map((res, i) => {
              ...
              return (
                <ScrollReveal key={res.title} delay={i * 0.05}>
                  <div className="glass rounded-3xl p-8 border border-white/8 hover:border-[#F05B1B]/30 hover:bg-[#0d1619]/80 transition-all duration-300 flex flex-col justify-between h-full">
                    <div>
                    ...
                    <Link
                      href={res.href}
                      className="group inline-flex items-center gap-2 text-white hover:text-[#F05B1B] text-xs font-bold uppercase tracking-wider transition-colors duration-200 mt-auto"
                    >
                      {res.linkText}
          ...
          {/* Quick FAQ preview */}
          <div className="glass rounded-[32px] p-8 lg:p-12 border border-white/5 bg-white/[0.01]">
            <h3 className="text-3xl font-black text-white mb-8">Frequently Asked Questions</h3>
            <div className="grid md:grid-cols-2 gap-8">
              <div>
                <h4 className="text-white font-bold text-base mb-2">What is Nexa's standard SLA response window?</h4>
              ...
              <div>
                <h4 className="text-white font-bold text-base mb-2">Are CCTV systems CNIA and Civil Defense compliant?</h4>
                <p className="text-white/45 text-sm leading-relaxed">
