...
export default function Technologies() {
  return (
    <section className="py-16 bg-[#070f12] relative overflow-hidden border-b border-white/5">
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8">
        <div className="text-center mb-8">
          <span className="text-white/30 text-[9px] font-black tracking-[0.25em] uppercase">
            Technology Partners
          </span>
        </div>
        ...
        <div className="flex flex-wrap items-center justify-center gap-x-12 gap-y-6 opacity-40">
          {partners.map((partner, index) => (
            <motion.div
              ...
              className="flex items-center gap-2 hover:opacity-100 transition-opacity duration-300 cursor-pointer"
            >
              ...
              {partner.name === 'Hewlett Packard Enterprise' && (
                <svg className="w-5 h-3 text-white" viewBox="0 0 24 12" fill="currentColor">
              ...
              <span className="text-white text-xs font-black tracking-[0.2em] uppercase whitespace-nowrap">
                {partner.label}
              </span>
            </motion.div>
          ))}
